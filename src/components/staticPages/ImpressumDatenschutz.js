      ...
      <div class="p-6 bg-violet-100 rounded-lg">
        ...
        >
          <div class="p-5 px-2.5">
            ...
            <div class="text-4xl py-4">Haftungsausschluss</div>
            <p class="pb-2.5">
              Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt.
              Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte
              können wir jedoch keine Gewähr übernehmen. Als Dienstanbieter*in
              ...
              sind wir als Dienstanbieter*in jedoch nicht verpflichtet,
            ...
            <div class="text-4xl py-4">Haftung für Links</div>
            <p class="pb-2.5">
              Unser Angebot enthält Links zu externen Webseiten Dritter, auf
              deren Inhalte wir keinen Einfluss haben. Deshalb können wir für
              diese fremden Inhalte auch keine Gewähr übernehmen. Für die
              Inhalte der verlinkten Seiten ist stets der*die jeweilige
              Anbieter*in oder Betreiber*in der Seiten verantwortlich. Die
            ...
            <div class="text-4xl py-4">Urheberrecht</div>
            <p class="pb-2.5">
              Die durch den*die Seitenbetreiber*in erstellten bzw. verwendeten
              ...
              bedürfen der Zustimmung des*der jeweiligen Autor*in bzw.
              ...
              Inhalte auf dieser Seite nicht von dem*der Betreiber*in erstellt
